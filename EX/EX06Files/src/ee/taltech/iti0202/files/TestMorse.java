...
class MorseTranslatorTest {
    ...
    void addMorseCodesBufferReader() {
        ...
        result.put("c", "-.-.");
        result.put("d", "-..");
        assertEquals(result, translator.addMorseCodes(reader.readTextFromFile("C:\\Users\\volos\\IdeaProjects\\iti0202-2022\\EX\\EX06Files\\src\\ee\\taltech\\iti0202\\files\\input\\morse.txt")));
    }
    ...
    void writeLinesToFile() {
        ...
        assertTrue(writer.writeLinesToFile(listWithWords, "C:\\Users\\volos\\IdeaProjects\\iti0202-2022\\EX\\EX06Files\\src\\ee\\taltech\\iti0202\\files\\input\\check.txt"));
    }
    ...
    void translateLinesToMorse() {
        ...
        InputFilesBufferReader reader = new InputFilesBufferReader();
        translator.addMorseCodes(reader.readTextFromFile("C:\\Users\\volos\\IdeaProjects\\iti0202-2022\\EX\\EX06Files\\src\\ee\\taltech\\iti0202\\files\\input\\morse.txt"));
        list.add("a");
        list.add("d");
        list.add("cd ad");
