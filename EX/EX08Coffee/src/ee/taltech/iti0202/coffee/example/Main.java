...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(machine.produceDrink(Drink.TypeOfDrink.CAPPUCCINO)); //make cappucino using ordinary machine
        ...
        System.out.println(machine.produceDrink(Drink.TypeOfDrink.ESPRESSO)); //cant make drink, cause bin is full
        machine.cleanBin();
        ...
        System.out.println(machine.produceDrink(Drink.TypeOfDrink.CAPPUCCINO));
        System.out.println(water.getMillilitersOfWater()); //check our state of water, it is 0
        ArrayList<Drink.TypeOfDrink> orderlist = new ArrayList<>();
        orderlist.add(Drink.TypeOfDrink.CAPPUCCINO);
        orderlist.add(Drink.TypeOfDrink.CACAO);
        System.out.println(newKitchen.makeAnOrder(machine1, orderlist));
        System.out.println(water.getMillilitersOfWater()); //check our state of water, it is 0
        machine2.setUpCapsule(Drink.TypeOfDrink.CACAO);
        water.fillWaterBank(); //fill bank of water
